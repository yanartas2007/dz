...
//        ResearchHub_withList<LaboratoryItem> rh = new ResearchHub_withList<>(new LaboratoryItem[2], 2);
//        rh.register(li1);
...
//        ResearchHub_withList<ResearchSample<Double>> rh1 = new ResearchHub_withList<>(new ResearchSample[2], 2);
//        rh1.register(rd);
...
//        ResearchHub_withList<LaboratoryItem> rli = new ResearchHub_withList<>(new LaboratoryItem[2], 2);
//        rli.register(rd);
//        rli.register(md);
//        rli.register(li1);
...
//        ResearchHub_withList<ResearchSample<?>> rh2 = new ResearchHub_withList<>(new ResearchSample[2], 2);
//        rh2.register(rd1);
//        rh2.register(ri1);
//        rh2.register(rf1);
...
//        ResearchHub_withList<LaboratoryItem> rh4 = new ResearchHub_withList<>(li3, 5);
//        rh4.clearByHazardLevel(5);
//        LabUnits.about(rh4.getStorage());
//        ResearchHub_withList<MedicalDevice> rm  = new ResearchHub_withList<>(new MedicalDevice[2], 2);
